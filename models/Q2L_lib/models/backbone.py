...
import models
from models.Q2L_lib.models.cls_cvt import build_CvT
from models.Q2L_lib.models.swin_transformer import build_swin_transformer
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        if name in ['resnet18', 'resnet50', 'resnet34', 'resnet101']:
            ...
            backbone = getattr(models.Q2L_lib.models, name)(
                {'num_classes': 1}
            )
