...
from models.Q2L_lib.models.backbone import build_backbone
from models.Q2L_lib.models.transformer import build_transformer
from models.Q2L_lib.utils.misc import clean_state_dict
...
class Qeruy2Label(nn.Module):
    ...
    def forward(self, input):
        input = torchvision.transforms.Resize(448)(input)
        #print(input.shape)
        ...
        #print(self.input_proj(src).shape,query_input.shape,pos.shape)
        #print(self.input_proj(src).shape,query_input)
...
def build_q2l(args):
    ...
    # for 16c equpment
    if args.backbone=='tresnetl':
        model.backbone[0].body.body.conv1[0] = torch.nn.Conv2d(256, 76, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
